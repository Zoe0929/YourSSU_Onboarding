...
//  MusicPlayer
//
//  Created by 지희의 MAC on 2022/07/12.
//
//
...
//        self.addViewsWithCode()
    ...
    func addPlayPauseButton() {
        ...
        centerY = NSLayoutConstraint(item: button, attribute: NSLayoutConstraint.Attribute.centerY,NSLayoutConstraint.Attribute, relatedBy: NSLayoutConstraint.Relation.equal, toItem: self.view, attribute: NSLayoutAttribute.centerY, multiplier: 0.8, constant: 0)
